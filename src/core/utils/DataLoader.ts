...
// JSON data interfaces - These are the raw shapes of JSON data before conversion to model types
export interface PropertyTypeData {
  id: string;
  name: string;
  type: string; // Will be converted to PropertyType enum
  size: string; // Will be converted to PropertySize enum
...
export interface FacilityTypeData {
  id: string;
  name: string;
  type: string; // Will be converted to FacilityType enum
  category: string; // Will be converted to FacilityCategory enum
  description: string;
  buildRequirements: {
    resources: {
      gold: number;
    ...
    propertyTypes?: string[]; // Will be converted to PropertyType[] enum
    propertySize?: string[]; // Will be converted to PropertySize[] enum
    specializations?: string[]; // Will be converted to SpecializationType[] enum
    requiredFacilities?: string[]; // Will be converted to FacilityType[] enum
  };
  maintenance?: MaintenanceCost;
  effects: {
...
export class DataLoader {
  ...
  // Helper method to get a raw material by ID - now using the lookup map for efficiency
  ...
  // Helper method to get a special material by ID - now using the lookup map for efficiency
  ...
  // Helper method to get a property type by ID - now using the lookup map for efficiency
  ...
  // Helper method to get a facility type by ID - now using the lookup map for efficiency
